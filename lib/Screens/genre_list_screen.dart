...
class _GenreScreenState extends State<GenreScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    provider.loadMovieByGenre(widget.genreId, 1);

    // provider.addMovieByGenre(widget.genreId, pageNumber);
          ...
          body: Container(
            ...
            child: GridView.builder(
                ...
                gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                    ...
                    mainAxisExtent: 380),
                itemCount: provider.movieByGenreList.length,
                        ...
                        child: Container(
                          child: ClipRRect(
                            ...
                            child: CachedNetworkImage(
                              imageUrl:
                                  'https://image.tmdb.org/t/p/original/${provider.movieByGenreList[index].posterPath}',
