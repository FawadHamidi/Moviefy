                      ...
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (context) => MovieDetailPage(
                                    movie: provider.movieList[index],index: index,
                                  )));
                    },
                    child: Container(
                      child: ClipRRect(
                        ...
                        child: CachedNetworkImage(
                          imageUrl:
                              'https://image.tmdb.org/t/p/original/${provider.movieList[index].posterPath}',
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        StarRate(
                          vote: provider.movieList[index].voteAverage,
                        ),
                      ],
                    ),
                  ),
