...
class TopRatedMovies extends StatefulWidget {
  ...
  TopRatedMovies({this.pageNumber = 1});
...
class _TopRatedMoviesState extends State<TopRatedMovies> {
  ...
  Widget build(BuildContext context) {
    ...
    return provider.topRatedMoviesList == null
        ...
        : Container(
            ...
            child: ListView.separated(
              ...
              itemBuilder: (context, index) {
                if (index == provider.topRatedMoviesList.length)
                  return TextButton(
                      onPressed: () {
                          ...
                          Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: (context) => MovieDetailPage(
                                        movie:
                                            provider.topRatedMoviesList[index],index: index
                                      )));
                        },
                        child: ClipRRect(
                          ...
                          child: CachedNetworkImage(
                            imageUrl:
                                'https://image.tmdb.org/t/p/original/${provider.topRatedMoviesList[index].backDropPath}',
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            StarRate(
                              vote: provider
                                  .topRatedMoviesList[index].voteAverage,
                            )
                          ],
                        ),
                      ),
              ...
              itemCount: provider.topRatedMoviesList.length + 1,
            ),
          );
  }
}
